...
# MAGIC GRANT USE SCHEMA ON SCHEMA odl_user_1142764_databrickslabs_com_retail TO `account users`;
# MAGIC GRANT SELECT ON TABLE odl_user_1142764_databrickslabs_com_retail.churn_features TO `account users`;
